...
public class HashFunction {
    ...
    HashFunction(int size) {
        ...
        arraySize = size;
        theTable = new String[size];
        Arrays.fill(theTable, "-1");
    ...
    public static void main(String[] args) {
        ...
        theFunc.hashFunction2(elementsToAdd2, theFunc.theTable);
    ...
    public String findKey(String key) {
        ...
        while (theTable[arrayIndexHash] != "-1") {

            if (theTable[arrayIndexHash] == key) {

                // Found the key so return it
                System.out.println(key + " was found in index "
                        + arrayIndexHash);

                return theTable[arrayIndexHash];
    ...
    public void displayTheStack() {
        ...
        for (int m = 0; m < 3; m++) {
            ...
            for (int n = increment - 10; n < increment; n++) {
                ...
                if (theTable[n].equals("-1"))
                    System.out.print("|      ");

                else
                    System.out
                            .print(String.format("| %3s " + " ", theTable[n]));
